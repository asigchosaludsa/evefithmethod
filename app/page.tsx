    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-20 sm:px-6">
          <Reveal>
            <div className="grid gap-4 lg:grid-cols-3">
              <article className="group relative overflow-hidden rounded-2xl border border-border bg-surface p-7 lg:col-span-2 lg:row-span-2">
                <div
                  aria-hidden
        ...
        <section className="mx-auto max-w-6xl px-4 pb-24 sm:px-6">
          <Reveal className="relative overflow-hidden rounded-3xl border border-primary/25 bg-gradient-to-b from-primary/12 to-transparent p-10 text-center sm:p-16">
            <div
              aria-hidden
